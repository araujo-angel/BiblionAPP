...
public class TinyDB {
    ...
    public String getUserEmail() {
        return getString("user_email"); // Chave consistente
    }
    ...
    public ArrayList<BookModel> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<BookModel> playerList = new ArrayList<BookModel>();

        for (String jObjString : objStrings) {
            BookModel player = gson.fromJson(jObjString, BookModel.class);
    ...
    public void putListObject(String key, ArrayList<BookModel> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (BookModel player : playerList) {
